...
#         return Student.objects.create(**validated_date)
...
class StudentSerializer(serializers.ModelSerializer):
    ...
    path = serializers.StringRelatedField() #read only bu veri ile öğrenci create edilemez.
